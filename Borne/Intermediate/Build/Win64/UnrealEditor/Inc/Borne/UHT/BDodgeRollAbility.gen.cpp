...
struct Z_Construct_UClass_UBDodgeRollAbility_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BackwardsDash_MetaData[] = {
		{ "Category", "DodgeAbility" },
		{ "ModuleRelativePath", "GAS/Abilities/Active/BDodgeRollAbility.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_BackwardsDash;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UBDodgeRollAbility_Statics::NewProp_BackwardsDash = { "BackwardsDash", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UBDodgeRollAbility, BackwardsDash), Z_Construct_UClass_UAnimMontage_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BackwardsDash_MetaData), NewProp_BackwardsDash_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UBDodgeRollAbility_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UBDodgeRollAbility_Statics::NewProp_BackwardsDash,
};
