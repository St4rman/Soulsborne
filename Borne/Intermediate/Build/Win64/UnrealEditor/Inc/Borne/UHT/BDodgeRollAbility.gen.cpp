...
struct Z_CompiledInDeferFile_FID_Borne_Source_Borne_GAS_Abilities_Active_BDodgeRollAbility_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UBDodgeRollAbility, UBDodgeRollAbility::StaticClass, TEXT("UBDodgeRollAbility"), &Z_Registration_Info_UClass_UBDodgeRollAbility, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UBDodgeRollAbility), 2486786241U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Borne_Source_Borne_GAS_Abilities_Active_BDodgeRollAbility_h_2760183810(TEXT("/Script/Borne"),
