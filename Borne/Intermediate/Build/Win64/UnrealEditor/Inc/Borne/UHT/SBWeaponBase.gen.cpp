...
{
	struct SBWeaponBase_eventIsWeaponEquipped_Parms
	{
		bool ReturnValue;
	};
#if WITH_METADATA
...
void Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::NewProp_ReturnValue_SetBit(void* Obj)
{
	((SBWeaponBase_eventIsWeaponEquipped_Parms*)Obj)->ReturnValue = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(SBWeaponBase_eventIsWeaponEquipped_Parms), &Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::NewProp_ReturnValue_SetBit, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASBWeaponBase, nullptr, "IsWeaponEquipped", nullptr, nullptr, Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::PropPointers), sizeof(Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::SBWeaponBase_eventIsWeaponEquipped_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::SBWeaponBase_eventIsWeaponEquipped_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ASBWeaponBase_IsWeaponEquipped_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ASBWeaponBase::execIsWeaponEquipped)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class ASBWeaponBase Function IsWeaponEquipped

// Begin Class ASBWeaponBase Function OnWeaponDrop_Implementation
struct Z_Construct_UFunction_ASBWeaponBase_OnWeaponDrop_Implementation_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Weapons/SBWeaponBase.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASBWeaponBase_OnWeaponDrop_Implementation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASBWeaponBase, nullptr, "OnWeaponDrop_Implementation", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020400, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASBWeaponBase_OnWeaponDrop_Implementation_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASBWeaponBase_OnWeaponDrop_Implementation_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_ASBWeaponBase_OnWeaponDrop_Implementation()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ASBWeaponBase_OnWeaponDrop_Implementation_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ASBWeaponBase::execOnWeaponDrop_Implementation)
{
	P_FINISH;
	P_NATIVE_BEGIN;
...
// End Class ASBWeaponBase Function OnWeaponDrop_Implementation
...
// Begin Class ASBWeaponBase Function StopFloating
static const FName NAME_ASBWeaponBase_StopFloating = FName(TEXT("StopFloating"));
void ASBWeaponBase::StopFloating()
{
	UFunction* Func = FindFunctionChecked(NAME_ASBWeaponBase_StopFloating);
	...
	{
		StopFloating_Implementation();
	}
}
struct Z_Construct_UFunction_ASBWeaponBase_StopFloating_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Weapons/SBWeaponBase.h" },
...
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ASBWeaponBase_StopFloating_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ASBWeaponBase, nullptr, "StopFloating", nullptr, nullptr, nullptr, 0, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x08020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_ASBWeaponBase_StopFloating_Statics::Function_MetaDataParams), Z_Construct_UFunction_ASBWeaponBase_StopFloating_Statics::Function_MetaDataParams) };
UFunction* Z_Construct_UFunction_ASBWeaponBase_StopFloating()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ASBWeaponBase_StopFloating_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(ASBWeaponBase::execStopFloating)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	P_THIS->StopFloating_Implementation();
	P_NATIVE_END;
}
// End Class ASBWeaponBase Function StopFloating
...
void ASBWeaponBase::StaticRegisterNativesASBWeaponBase()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "StopFloating", &ASBWeaponBase::execStopFloating },
	};
...
struct Z_Construct_UClass_ASBWeaponBase_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ASBWeaponBase_StopFloating, "StopFloating" }, // 372086275
	};
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ASBWeaponBase_Statics::NewProp_MeshComp = { "MeshComp", nullptr, (EPropertyFlags)0x001000000008000c, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ASBWeaponBase, MeshComp), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MeshComp_MetaData), NewProp_MeshComp_MetaData) };
...
const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ASBWeaponBase_Statics::InterfaceParams[] = {
	{ Z_Construct_UClass_UWeaponInterface_NoRegister, (int32)VTABLE_OFFSET(ASBWeaponBase, IWeaponInterface), false },  // 2173716592
};
...
struct Z_CompiledInDeferFile_FID_Borne_Source_Borne_Weapons_SBWeaponBase_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ASBWeaponBase, ASBWeaponBase::StaticClass, TEXT("ASBWeaponBase"), &Z_Registration_Info_UClass_ASBWeaponBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ASBWeaponBase), 2329990561U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Borne_Source_Borne_Weapons_SBWeaponBase_h_1695913705(TEXT("/Script/Borne"),
