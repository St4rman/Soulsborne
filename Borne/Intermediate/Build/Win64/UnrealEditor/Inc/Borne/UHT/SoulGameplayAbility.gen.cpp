...
struct Z_CompiledInDeferFile_FID_Borne_Source_Borne_GAS_Abilities_SoulGameplayAbility_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_USoulGameplayAbility, USoulGameplayAbility::StaticClass, TEXT("USoulGameplayAbility"), &Z_Registration_Info_UClass_USoulGameplayAbility, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USoulGameplayAbility), 1700205235U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Borne_Source_Borne_GAS_Abilities_SoulGameplayAbility_h_3028213930(TEXT("/Script/Borne"),
